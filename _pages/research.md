...
permalink: /research/
title: research
description: Atmospheric science and engineering across scales, from turbulence measurements to structural response.
nav: true
nav_order: 1
toc:
  sidebar: left
...
Research code, datasets, and documentation are released whenever possible. My open outputs include MATLAB and Python tools for turbulence simulation, modal identification, structural response, wind-resource analysis, and lidar processing. See [software & data]({% link _pages/software.md %}) for selected resources.
