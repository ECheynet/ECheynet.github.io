...
permalink: /cv/
title: CV
description: Academic appointments, qualifications, leadership, and professional service.
nav: true
nav_order: 7
toc:
  sidebar: left
...
| -----------: | ----------------------- | ----------------------- |
| 2022–present | Associate Professor     | University of Bergen    |
|    2019–2022 | Postdoctoral Researcher | University of Bergen    |
...
- Scientific committee member and metocean session chair for EERA DeepWind.
...
- Tom A. Wyatt Best Paper Award for wind-engineering research.
- More than 70 verified peer reviews across atmospheric science, wind engineering, remote sensing, and structural dynamics journals.

For the complete publication record, invited talks, committee work, awards, and outreach activities, please consult the [full CV]({{ '/assets/pdf/CV_Cheynet_2026.pdf' | relative_url }}).
